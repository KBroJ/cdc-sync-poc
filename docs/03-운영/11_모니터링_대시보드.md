...
> 이 문서는 CDC 동기화 시뮬레이터 사용법을 설명합니다.
> (기존 모니터링 대시보드 → 동기화 시뮬레이터로 변경됨, 2026-01-14)
...
| http://localhost:8082/dashboard | 기존 URL (→ /simulator 리다이렉트) |
...
> **관련 문서:**
> - [09_소스레벨_상세_설명서.md](../02-구현/09_소스레벨_상세_설명서.md) - 소스 레벨 설명
> - [10_테스트_및_확인_방법.md](10_테스트_및_확인_방법.md) - 테스트 가이드
> - [17_대시보드_개선_계획.md](../02-구현/17_대시보드_개선_계획.md) - 시뮬레이터 개선 계획
