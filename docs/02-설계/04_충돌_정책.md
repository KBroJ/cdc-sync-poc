...
> **목표**: 양방향 동기화에서 발생하는 충돌과 해결 정책을 이해합니다.
>
> **문서 상태**: ⚠️ **임시(Draft)** - PoC 학습용으로 작성된 초안입니다.
> - SYNC_CONFLICT_POLICY 테이블은 설계만 되어 있고 미구현
> - LWW, ASIS_PRIORITY 등 정책은 개념 정리용
> - 실제 프로젝트에서는 업무 요건에 맞게 정책 확정 필요
